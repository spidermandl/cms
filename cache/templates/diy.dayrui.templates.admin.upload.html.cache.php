...
<div class="pad-10">
	<div class="table-list col-tab" id="myform">
		...
		<ul class="tabBut cu-li">
			...
			<?php if ($member['adminid']) { ?><li onclick="SwapTab2(2);set_iframe('myattach', '<?php echo SITE_HOME; ?>/index.php?s=member&c=api&m=myattach&ext=<?php echo $ext; ?>&fcount=<?php echo $fcount; ?>');"><?php echo fc_lang('网站附件'); ?></li><?php }  if ($notused) { ?><li onclick="SwapTab2(3);"><?php echo fc_lang('未使用的文件'); ?></li><?php } ?>
		</ul>
		<?php } ?>
