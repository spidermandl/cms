            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        <li><a href="<?php echo SITE_URL; ?>" target="_blank"><i class="icon-home"></i> <?php echo fc_lang('网站首页'); ?> </a></li>
                        ...
                        <li><a href="<?php echo dr_url('check/index'); ?>" target="right"><i class="icon-zoom-out"></i> <?php echo fc_lang('系统体检'); ?></a></li>
                        <?php } ?>
						...
						<li><a href="http://www.dayrui.com" target="_blank"><i class="fa fa-comment"></i> <?php echo dr_lang('技术支持'); ?></a></li>
                   </ul>
                </li>
            </ul>
        </div>
...
<div class="page-footer">
    <div class="row myindexfooter">
        <div class="col-md-6 full-left">
            <a href="<?php echo SITE_URL; ?>" target="_blank" style="color:#000">&copy; <?php echo SITE_NAME; ?></a>
        </div>
        <div class="col-md-6 full-right text-right">
            <strong><?php echo DR_NAME; ?></strong>&nbsp;v<?php echo DR_VERSION; ?> (<?php echo DR_UPDATE; ?>)
        </div>
    </div>
