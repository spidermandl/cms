...
function dr_confirm_move() {
	var d = top.dialog({
		title: lang["tips"],
		fixed: true,
		content: '<img src="<?php echo dr_absolute_url("/statics/js/skins/icons/question.png"); ?>"> <?php echo fc_lang("您确定要这样操作吗？"); ?>',
		okValue: lang['ok'],
		ok: function () {
			$('#action').val('move');
...
function dr_status(id, v) {
	...
	var d = top.dialog({
		title: lang["tips"],
		fixed: true,
		content: '<img src="<?php echo dr_absolute_url("/statics/js/skins/icons/question.png"); ?>"> '+title,
		okValue: lang['ok'],
		ok: function () {
