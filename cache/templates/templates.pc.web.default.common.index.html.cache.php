										...
										<tr>
											<td class="pic" id="bimg">
												...
												<div class="<?php if ($key==0) { ?>dis<?php } else { ?>undis<?php } ?>" name="f">
													<a href="<?php echo dr_absolute_url($t['url']); ?>" title="<?php echo $t['title']; ?>" <?php if ($t['target']) { ?>target="_blank"<?php } ?>><img alt="<?php echo $t['title']; ?>" style="width: 100%; height: 260px;" src="<?php echo dr_thumb($t['thumb'], 350, 260); ?>" border="0"></a>
												</div>
												<?php } } ?>
												<table id="font_hd" width="100%" cellSpacing="0" cellPadding="0">
													<tr>
														<td class="title" id="info">
															<?php $return = $this->list_tag("action=navigator type=1"); if ($return) extract($return); $count=count($return); if (is_array($return)) { foreach ($return as $key=>$t) { ?>
															<div class="<?php if ($key==0) { ?>dis<?php } else { ?>undis<?php } ?>" name="f">
																<a href="<?php echo dr_absolute_url($t['url']); ?>" title="<?php echo $t['title']; ?>" <?php if ($t['target']) { ?>target="_blank"<?php } ?>><?php echo $t['title']; ?></a>
															</div>
															<?php } } ?>
														</td>
								...
								<div class="portlet-title ">
									<div class="row">
										<div class="col-md-12">
											...
											<h4><a cl href="<?php echo dr_absolute_url($t['url']); ?>" <?php if ($t['target']) { ?>target="_blank"<?php } ?> class="title"><?php echo $t['title']; ?></a></h4>
											<?php } else {  if ($key==1) { ?><p class="links"><?php } ?>
											<a href="<?php echo dr_absolute_url($t['url']); ?>" <?php if ($t['target']) { ?>target="_blank"<?php } ?>>[<?php echo $t['title']; ?>]</a>
							...
							<div class="portlet light">
								<div class="portlet-title">
									...
									<ul class="nav nav-tabs">
										...
										<li><a href="<?php echo dr_absolute_url($t['url']); ?>"><?php echo $t['name']; ?></a></li>
										<?php } } ?>
									</ul>
								</div>
								<div class="portlet-body">
											...
											<div class="row">
												<div class="col-md-12 media">
													...
													<div class="media-body">
														<h5 class="media-heading"><a href="<?php echo dr_absolute_url($t['url']); ?>" class="title"><?php echo $t['title']; ?></a></h5>
											...
											<div class="row" style="margin-top: 10px">
												<div class="col-md-6">
													<ul class="list-unstyled">
														...
														<li style="line-height: 23px"><span class="badge badge-empty badge-success"></span>&nbsp;<a href="<?php echo dr_absolute_url($t['url']); ?>" class="title"><?php echo dr_strcut($t['title'], 28); ?></a></li>
														<?php } } ?>
													</ul>
												</div>
												<div class="col-md-6">
												...
												<div class="col-sm-4" style="overflow:hidden">
													<div class="tile-container">
														<div class="tile-thumbnail">
															<a href="javascript:;">
																<a href="<?php echo dr_absolute_url($t['url']); ?>" ><img src="<?php echo dr_thumb($t['thumb'], 120, 75); ?>" height="75"></a>
															</a>
														</div>
														<div class="tile-title">
															<h5><a href="<?php echo dr_absolute_url($t['url']); ?>" class="title"><?php echo dr_strcut($t['title'], 15); ?></a></h5>
														</div>
													</div>
												</div>
											<?php } } ?>
						...
						<div class="col-lg-12">
							<div class="portlet light">
								<div class="portlet-title">
									<div class="caption">
										<i class=" icon-layers font-green"></i>
										<span class="caption-subject bold uppercase"><a class=" font-green" href="<?php echo dr_absolute_url('/index.php?s=photo'); ?>">图片模块</a></span>
									</div>
									<ul class="nav nav-tabs">
										<!-- 调用其子栏目 -->
									...
									<div class="row">
										...
										<div class="col-sm-3">
											<div class="tile-container">
												<div class="tile-thumbnail">
													<a href="javascript:;">
														<a href="<?php echo dr_absolute_url($t['url']); ?>" ><img src="<?php echo dr_thumb($t['thumb'], 250, 200); ?>" width="250" height="200"></a>
													</a>
												</div>
												<div class="tile-title">
													<h5><a href="<?php echo dr_absolute_url($t['url']); ?>" class="title"><?php echo dr_strcut($t['title'], 28); ?></a></h5>
												</div>
											</div>
										</div>
										<?php } } ?>
						...
						<div class="col-lg-12">
							<div class="portlet light">
								<div class="portlet-title">
									<div class="caption">
										<i class=" icon-layers font-green"></i>
										<span class="caption-subject bold uppercase"><a class=" font-green" href="<?php echo dr_absolute_url('/index.php?s=down'); ?>">下载模块</a></span>
									</div>
									<ul class="nav nav-tabs">
										<!-- 调用其子栏目 -->
							...
							<div class="portlet light">
								...
								<div class="portlet-body">
									<div class="row">
										...
										<a href="<?php echo dr_absolute_url($t['url']); ?>" title="<?php echo $t['title']; ?>" <?php if ($t['target']) { ?>target="_blank"<?php } ?>><?php echo $t['name']; ?></a>
										<?php } } ?>
											</div>
									</div>
								</div>
