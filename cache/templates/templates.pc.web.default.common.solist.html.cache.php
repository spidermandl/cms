...
<div class="clr sr_body sr_list">
    <div class="sr_main">
        ...
        <div class="wrap sr_logo">
            <a href="<?php echo dr_so_url(); ?>" class="l" style="padding-top: 20px;padding-right: 20px;"><img src="<?php echo HOME_THEME_PATH; ?>layouts/layout3/img/logo.png" /></a>
            <div class="l">
            ...
            <div class="l">
                <div>
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo dr_so_url($params, 'module', $dir); ?>" <?php if ($dir==$dirname) { ?>class="ac"<?php } ?>><?php echo $t['name']; ?>（<?php echo intval($t['search']['sototal']); ?>）</a></li>
                        <?php } } ?>
                    </ul>
                </div>
                <div class="bgno">
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo dr_so_url($params, 'updatetime', $t); ?>" <?php if ($get['updatetime']==$t) { ?>class="ac"<?php } ?>><?php echo $i; ?></a></li>
                        <?php } } ?>
                    </ul>
                </div>
            </div>
    ...
    <div class="sr_footer">
        <p class="cp">Powered by <?php echo DR_NAME; ?> v<?php echo DR_VERSION; ?> © 2011-2017 Dayrui Inc.</p>
    </div>
